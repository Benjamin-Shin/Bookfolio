...
- **Design (KO):** [docs/bookfolio-points-themes-i18n-vip-design.md](docs/bookfolio-points-themes-i18n-vip-design.md) — 포인트(음수)·VIP·플랜 cap·모바일 테마·i18n·모임서가·출석·UTC/로컬 시각 통합 요약.
