...
| `subscription_plans` | VIP 등 플랜 마스터·`caps_json` (`0024`) |
...
`0001` … `0026` — 저장소 `supabase/migrations/` 디렉터리 (`0024`: 포인트 음수·VIP·출석·타임존·잔액 뷰, `0025`: 공동서재 추가·초과 초대 포인트 이벤트 시드, `0026`: 북폴리오 집계 RPC).
