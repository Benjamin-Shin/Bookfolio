...
function ownerDisplayName(o: LibraryAggregatedBookRow["owners"][number]): string {
  const n = o.name?.trim();
...
/**
 * 공동서재 집계 책 목록용 선반 UI (클라이언트 전용 — Link·Badge 하위 트리 하이드레이션 일치).
 *
 * @history
 ...
 * - 2026-03-24: 신규 — 대시보드 책장과 동일한 선반·표지 배치, 링크는 공동서재 도서 상세
 */
