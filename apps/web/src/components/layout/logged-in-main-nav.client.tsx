...
const NAV: { href: Route; label: string; isActive: (path: string) => boolean }[] =
  [
    {
      href: "/dashboard",
      label: "내 서가",
      isActive: (p) =>
        p === "/dashboard" ||
        (p.startsWith("/dashboard/books") &&
          !p.startsWith("/dashboard/libraries")),
    },
    {
      href: "/dashboard/bestsellers",
      label: "발견",
      isActive: (p) =>
        p.startsWith("/dashboard/bestsellers") ||
        p.startsWith("/dashboard/choice-new"),
    },
    {
      href: "/dashboard/libraries",
      label: "모임서가",
      isActive: (p) => p.startsWith("/dashboard/libraries"),
    },
    {
          ...
          >
            ...
            <span
              className={cn(
                ...
                active ? "bg-[#1A3C2F] opacity-100" : "bg-transparent opacity-0",
              )}
              aria-hidden
            />
          </Link>
