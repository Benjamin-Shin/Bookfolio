...
export const metadata: Metadata = {
  title: "서비스 약관 — 서가담",
  description:
    "서가담 서비스 이용 조건, 회원·이용자 권리와 의무, 약관 개정, 통지, 게시물·저작권, 포인트·VIP, 모임서가, 분쟁 해결 등에 관한 약관입니다.",
};

/**
 * @history
 * - 2026-04-13: 제20조에 회원 탈퇴 절차(웹·앱)·삭제 범위·모임서가 제한·문의처 상세 보강 및 앵커 `article-20-withdrawal`
 ...
 * - 2026-03-28: 현재 구현·설계 문서 기준 본문 정리(인증, 서가, 모임서가, 포인트·출석, VIP·구독·한도, 캐논 편집·투표, ISBN 조회·관리자 운영 등 반영; 향후 PG·결제 연계는 별도 고지 예정으로 명시)
    ...
    <div className="mx-auto max-w-3xl px-4 py-10 md:py-14">
      ...
      <div className="mt-8 space-y-8 text-sm leading-relaxed text-foreground/90">
        <section className="space-y-3">
          ...
          <p>
            본 약관은 운영자가 제공하는 서비스의 이용에 관하여 운영자와 회원 및
            비회원 이용자 간의 권리·의무 및 책임사항, 기타 필요한 사항을
            규정함을 목적으로 합니다.
          </p>
        </section>
        ...
        <section className="space-y-3">
          ...
          <ul className="list-disc space-y-1 pl-5">
            ...
            <li>
              <strong>&quot;사이트&quot;</strong>란 운영자가 운영하는 웹사이트
              및 모바일 애플리케이션 등 서비스가 구현되는 온라인 접속 경로를
              말합니다.
            </li>
            <li>
            ...
            <li>
              ...
              따라 운영자가 제공하는 서비스를 이용하는 회원 및 비회원을
              말합니다.
            </li>
            <li>
            ...
            <li>
              <strong>&quot;게시물&quot;</strong>이란 회원이 서비스 이용
              과정에서 사이트에 게시하거나 서비스에 저장·연동되는
              부호·문자·음성·음향·화상· 동영상 등의 정보 형태로 표시되는 글,
              사진, 동영상, 각종 파일과 링크 등을 말합니다.
            </li>
            <li>
              <strong>&quot;콘텐츠&quot;</strong>란 게시물과 유사하나
              입력·동기화 목적의 서지·메타데이터·메모·평가 등 서비스 내 정보를
              포괄적으로 일컫는 말로 쓸 수 있습니다.
            </li>
            <li>
              <strong>&quot;포인트&quot;</strong>란 운영 정책에 따라
              적립·차감되는 서비스 내부 수치로, 법정 통화가 아니며 원칙적으로
              현금으로 교환되지 않습니다.
            </li>
            <li>
            ...
            <li>
              <strong>&quot;유료 서비스&quot;</strong>란 운영자가 유료로
              제공하거나 추후 유료로 전환·추가할 수 있는 서비스(구독, 유료 기능,
              유료 테마 등)를 말합니다. 세부 조건은 서비스 화면 또는 별도
              약관에서 정합니다.
            </li>
          </ul>
        </section>
        ...
        <section className="space-y-3">
          ...
          <ul className="list-disc space-y-1 pl-5">
            ...
            <li>
              공지된 시행 일자 이후 회원이 서비스를 계속 이용하는 경우 개정
              약관에 동의한 것으로 봅니다. 동의하지 않는 회원은 이용 계약을
              해지(탈퇴)할 수 있습니다. 유료 서비스를 이용하는 회원이 개정에
              동의하지 않아 계약을 해지하는 경우 환불 등은 운영자가 정한 환불
              정책 및 관계 법령에 따릅니다.
            </li>
            <li>
        ...
        <section className="space-y-3">
          ...
          <p>
            본 약관에서 정하지 아니한 사항과 해석에 관하여는 「전자상거래
            등에서의 소비자 보호에 관한 법률」, 「약관의 규제에 관한 법률」,
            관계 법령 및 상관례에 따릅니다.
          </p>
        </section>
        ...
        <section className="space-y-3">
          ...
          <ul className="list-disc space-y-1 pl-5">
            ...
            <li>
              ...
              허위 정보를 이용한 경우, 운영자가 제시하는 필수 정보를 기재하지
              않은 경우,{" "}
              <strong>
            ...
            <li>
              회원이 가입 시 연락처·이메일 등을 부정확히 기재하여 발생한
              불이익에 대하여 운영자는 책임지지 않습니다.
            </li>
            <li>
            ...
            <li>
              운영자는 정책에 따라 등급·플랜별로 이용 시간, 이용 횟수, 메뉴 등을
              달리할 수 있습니다.
            </li>
            <li>
        ...
        <section className="space-y-3">
          ...
          <ul className="list-disc space-y-1 pl-5">
            <li>
              ...
              있습니다. 다만 서비스 관리·보안을 위해 계정 식별자(예: 이메일)
              등은 수정이 제한될 수 있으며, 연락처 변경 시 별도 인증을 요구할 수
              있습니다.
            </li>
            <li>
        ...
        <section className="space-y-3">
          ...
          <p>
            운영자는 정보통신망법, 「개인정보 보호법」 등 관계 법령이 정하는
            바에 따라 회원의 개인정보를 보호하기 위해 노력합니다. 개인정보의
            수집·이용· 제공 등에 관하여는 별도의{" "}
            <a
            ...
            사이트·앱에서는 운영자의 개인정보처리방침이 적용되지 않을 수
            있습니다.
          </p>
        </section>
        ...
        <section className="space-y-3">
          ...
          <ul className="list-disc space-y-1 pl-5">
            ...
            <li>
              운영자는 계정 식별자가 개인정보 유출 우려, 공서양속에 반하거나
              운영자 또는 운영자로 오인할 우려가 있는 경우 이용을 제한할 수
              있습니다.
            </li>
            <li>
              도용 또는 제3자 사용이 의심되는 경우 즉시 운영자에 통지하고 안내에
              따라야 하며, 통지·협력을 게을리하여 발생한 불이익에 대하여
              운영자는 책임지지 않습니다.
            </li>
          </ul>
        </section>
        ...
        <section className="space-y-3">
          ...
          <p>
            ...
            위해 공지하는 행동 기준·운영 정책을 따릅니다. 운영 정책은 모든
            행위를 열거하지 않을 수 있으며, 운영자는 서비스의 온전함을 보호하기
            위해 경고, 이용 제한, 콘텐츠 삭제, 계정 정지, 포인트 회수 등 필요한
            조치를 취할 수 있고 운영 정책을 개정할 수 있습니다.
          </p>
          <p>회원은 특히 다음 각 호의 행위를 하여서는 안 됩니다.</p>
          <ul className="list-disc space-y-1 pl-5">
            <li>
              타인의 저작권·상표·초상권 등 지식재산권을 침해하는 게시물 게시
            </li>
            ...
            <li>
              시스템·보안 취약점 악용 또는 허가 없는 침입·데이터 수집 시도
            </li>
            <li>
              모임서가·공개 기능을 이용한 스팸·무단 영리 홍보(운영자가 허용하는
              경우 제외)
            </li>
        ...
        <section className="space-y-3">
          ...
          <ul className="list-disc space-y-1 pl-5">
            <li>
              개인 서가: 소장 도서 등록·편집·삭제, 읽기 상태·별점·메모·독서
              이벤트 기록
            </li>
            <li>
            ...
            <li>
              모임서가: 서가 생성·설명, 멤버 초대·역할, 일부 소장 정보의 공유
              표시
            </li>
            <li>포인트: 규칙에 따른 적립·차감, 일·월 한도 등 운영 정책</li>
            <li>
              출석·활동: 일 단위 활동 기록(타임존·로컬 날짜 기준 등 정책에 따름)
            </li>
            <li>
              플랜·VIP: 모임서가 개수·멤버·초대 한도, 메타 조회·스캔 등 이용
              한도와 연계된 혜택(구체 항목은 공지·정책에 따름)
            </li>
            <li>
              커뮤니티·서지 품질: 공개 한줄평, 공유 서지(캐논) 수정
              제안·검토·투표 등
            </li>
            <li>표지 등 이미지 업로드·저장(예: 클라우드 이미지 호스트 연동)</li>
            <li>웹 대시보드·모바일 앱을 통한 동일 계정 연동 이용</li>
            <li>
              <strong>향후</strong> 유료 테마·다국어(i18n)·결제(PG) 연동·VIP
              자동 갱신 등은 별도 공지·약관·개인정보 처리방침 보완과 함께 제공될
              수 있습니다.
            </li>
          </ul>
        </section>
        ...
        <section className="space-y-3">
          ...
          <ul className="list-disc space-y-1 pl-5">
            ...
            <li>
              설비 보수·점검, 교체·고장, 통신 두절, 운영상 상당한 사유가 있는
              경우 서비스 제공을 일시 중단할 수 있습니다. 이 경우 제9조의
              방법으로 통지하되, 사전 통지가 불가능한 부득이한 사유가 있으면
              사후 통지할 수 있습니다.
            </li>
            <li>
        ...
        <section className="space-y-3">
          ...
          <ul className="list-disc space-y-1 pl-5">
            <li>
              운영자는 서비스 이용에 필요하다고 인정되는 정보를
              공지사항·전자우편 등으로 제공할 수 있습니다. 다만 회원은 관계
              법령에 따른 거래 관련 정보 및 고객 문의 답변 등을 제외하고
              전자우편에 대한 수신을 거부할 수 있습니다.
            </li>
            <li>
            ...
            <li>
              운영자는 서비스 화면·사이트·전자우편 등에 광고를 게재할 수
              있습니다.
            </li>
            <li>
        ...
        <section className="space-y-3">
          ...
          <ul className="list-disc space-y-1 pl-5">
            ...
            <li>
              포인트는 원칙적으로 양도·현금 교환·상속의 대상이 되지 않으며,
              서비스 종료·정책 변경 시 소멸될 수 있습니다.
            </li>
            <li>
            ...
            <li>
              ...
              유효 기간을 명확히 표시하고, 관계 법령이 정하는 범위에서 이를
              안내할 수 있습니다.
            </li>
            <li>
              VIP 등 플랜 혜택에도 남용 방지를 위한 상한은 별도로 적용될 수
              있습니다.
            </li>
          </ul>
        </section>
        ...
        <section className="space-y-3">
          ...
          <p>
            ...
            따릅니다.{" "}
            <strong>본 약관 시점에는 PG 연동 자동 결제가 필수는 아니며</strong>,
        ...
        <section className="space-y-3">
          ...
          <ul className="list-disc space-y-1 pl-5">
            <li>
              회원이 모임서가에 소장 정보를 연결하거나 공개 한줄평 등을 게시하는
              경우, 초대된 멤버 또는 서비스 정책에 따라 정해진 범위에서 열람될
              수 있습니다.
            </li>
            ...
            <li>
              <strong>관리자·운영 스태프</strong> 등 내부 역할은 운영 목적에
              한해 시스템상 부여될 수 있으며, 권한 사용은 내부 정책·감사에
              따릅니다.
            </li>
          </ul>
        </section>
        ...
        <section className="space-y-3">
          ...
          <ul className="list-disc space-y-1 pl-5">
            <li>
              운영자가 서비스 내에 게시한 콘텐츠의 저작권은 운영자에게 귀속될 수
              있습니다.
            </li>
            <li>회원이 게시한 게시물의 저작권은 회원에게 귀속됩니다.</li>
            <li>
              회원이 게시하는 게시물은 검색 결과, 서비스·관련 프로모션 등에
              노출될 수 있으며, 해당 노출에 필요한 범위에서 복제·편집·표시될 수
              있습니다. 이 경우 운영자는 저작권법 등을 준수하며, 회원은 서비스
              내 설정· 고객 채널 등을 통해 삭제·비공개 등을 요청할 수
              있습니다(법령·기술적 한도 내).
            </li>
            <li>
              운영자가 제2항 이외의 방법으로 회원 게시물을 이용하려면 사전
              동의를 받습니다.
            </li>
            <li>
              게시물이 정보통신망법·저작권법 등에 위반된다고 인정되면 권리자는
              관계 법령에 따라 게시 중단 등을 요청할 수 있고, 운영자는 법령에
              따라 조치 합니다.
            </li>
            <li>
            ...
            <li>
              회원은 서비스 운영·개선·표시·백업·통계·분쟁 대응을 위해 필요한
              범위에서 운영자에게 비독점적 이용을 허락합니다(별도 동의 절차가
              있는 경우는 예외).
            </li>
          </ul>
        </section>
        ...
        <section className="space-y-3">
          ...
          <ul className="list-disc space-y-1 pl-5">
            <li>
              서비스에 대한 저작권 및 지적재산권은 운영자에 귀속됩니다. 단,
              회원의 게시물 및 제휴·라이선스에 따라 제공된 저작물 등은 예외로
              합니다.
            </li>
            <li>
        ...
        <section id="article-20-withdrawal" className="space-y-3 scroll-mt-24">
          ...
          <ul className="list-disc space-y-1 pl-5">
            <li>
              회원은 언제든지 아래 <strong>서비스 내 탈퇴 절차</strong>를 통해
              이용 계약을 해지할 수 있습니다. 탈퇴는{" "}
              <strong>로그인한 상태</strong>에서만 진행할 수 있습니다. 앱·웹
              이용이 어려운 경우에는 운영자가 안내하는 고객
              채널(개인정보처리방침의 문의처 등)을 통해 삭제(탈퇴)를 요청할 수
              있습니다.
            </li>
            <li>
          ...
          <div className="space-y-4 border-l-2 border-muted pl-4">
            <div className="space-y-2">
              ...
              <ol className="list-decimal space-y-1 pl-5">
                ...
                <li>
                  화면 상단 오른쪽의 <strong>프로필 설정</strong>(톱니바퀴
                  아이콘)을 눌러 <strong>프로필</strong> 창을 엽니다.
                </li>
                <li>
                  창 하단의 <strong>회원 탈퇴</strong>를 누르고, 안내를 확인한
                  뒤 <strong>탈퇴 확인</strong>으로 완료합니다.
                </li>
              </ol>
            </div>
            ...
            <div className="space-y-2">
              ...
              <ol className="list-decimal space-y-1 pl-5">
                <li>
                  앱 하단 탭에서 <strong>프로필</strong>을 선택합니다.
                </li>
                <li>
                  <strong>계정 설정</strong>에서 <strong>프로필 편집</strong>
                  으로 이동합니다.
                </li>
                <li>
                  화면 하단의 <strong>회원 탈퇴…</strong>를 누르고, 대화 상자
                  안내에 따라 확인합니다.
                </li>
              </ol>
            </div>
            ...
            <div className="space-y-2">
              ...
              <p>
                탈퇴를 확인하면 복구할 수 없는 범위에서 아래에 해당하는 정보가
                삭제되거나, 이용 계약 종료에 따라 처리됩니다.
              </p>
              <ul className="list-disc space-y-1 pl-5">
                <li>보유 포인트 및 포인트 원장 전체</li>
                <li>내 서가(소장 도서), 메모, 독서 이벤트 기록, 한줄평</li>
                <li>
                  내가 만든 모임서가 — 다른 멤버가 없으면 탈퇴와 함께 삭제되고,
                  다른 멤버가 있으면 탈퇴 전 소유권 이전이 필요합니다
                </li>
              ...
              <p className="rounded-md border border-amber-500/40 bg-amber-500/10 px-3 py-2 text-xs text-foreground">
                <strong>소유한 공동·모임 서가</strong>에 다른 멤버가 있으면
                탈퇴할 수 없습니다. 해당 서가 화면에서{" "}
                <strong>소유권을 다른 멤버에게 이전</strong>한 뒤 탈퇴해 주세요.
                본인만 남은 모임서가는 별도 삭제 없이 탈퇴 시 함께 정리됩니다.
              </p>
              <p className="text-xs text-muted-foreground">
                여러 이용자가 공유하는 서지 데이터(
                <code className="rounded bg-muted px-1">books</code> 등)는
                서비스 운영을 위해 그대로 둘 수 있습니다. 회원이 서비스에 남긴
                일부 정보·게시물은 자동으로 삭제되지 않거나, 타인의 권익과 얽혀
                분리·비식별 처리 등의 형태로 남을 수 있으니 탈퇴 전 필요한
                조치를 하시기 바랍니다.
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <p>
                탈퇴 후 개인정보 및 계정 데이터의 보유·삭제는 「개인정보
                보호법」 등 관계 법령 및{" "}
                <a
                  className="underline underline-offset-2 hover:text-foreground"
                  href="/privacy"
                ...
                에 따릅니다. 로그인이 불가능하거나 위 절차 진행이 어려운
                경우에도 동일 방침의 <strong>개인정보 보호 책임자·문의</strong>
                로 삭제(탈퇴) 요청을 보내실 수 있으며, 본인 확인에 필요한 정보를
                요청할 수 있습니다.
              </p>
        ...
        <section className="space-y-3">
          ...
          <p>
            유료 서비스 구매 회원이 환불을 신청하는 경우, 각 유료 상품·구독
            화면에 고지된 환불 규정 및 「전자상거래 등에서의 소비자 보호에 관한
            법률」 등 관계 법령에 따릅니다. 환불 금액 계산 방식(절상·절사 등)은
            결제 또는 운영 정책에서 정합니다.
          </p>
        </section>
        ...
        <section className="space-y-3">
          ...
          <ul className="list-disc space-y-1 pl-5">
            <li>
              운영자의 고의 또는 중대한 과실이 없는 한,
              간접적·특별·결과적·징벌적 손해 등에 대하여 책임을 지지 않을 수
              있습니다(관계 법령이 달리 규정하는 경우 제외).
            </li>
            <li>
              천재지변 또는 이에 준하는 불가항력으로 서비스를 제공할 수 없는
              경우 운영자의 책임이 면제될 수 있습니다.
            </li>
            <li>
              회원의 귀책 사유로 인한 이용 장애에 대하여 운영자는 책임지지
              않습니다.
            </li>
            <li>
            ...
            <li>
              회원 간 또는 회원과 제3자 간에 서비스를 매개로 한 거래 등에 대하여
              운영자는 책임을 지지 않습니다.
            </li>
            <li>
        ...
        <section className="space-y-3">
          ...
          <ul className="list-disc space-y-1 pl-5">
            ...
            <li>
              본 약관의 일부 규정이 대한민국의 강행 법규와 상충하는 경우 그 강행
              법규에 따르며, 일부 조항의 효력 정지가 다른 조항의 효력에 영향을
              주지 않습니다.
            </li>
          </ul>
        </section>
        ...
        <section className="space-y-3">
          ...
          <p>
            ...
            수 있습니다. 사업자 정보(상호·대표자·주소·통신판매업 신고 등)는
            서비스 초기면 또는 별도 페이지에 함께 게시하는 것이 좋습니다.
          </p>
        </section>
      </div>
    </div>
