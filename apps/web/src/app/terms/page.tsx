...
export const metadata: Metadata = {
  title: "서비스 약관 — 서가담",
  description:
    "서가담 서비스 이용 조건, 회원·이용자 권리와 의무, 약관 개정, 통지, 게시물·저작권, 포인트·VIP, 공동서가, 분쟁 해결 등에 관한 약관입니다.",
};

/**
 * @history
 * - 2026-04-13: 제20조에 회원 탈퇴 절차(웹·앱)·삭제 범위·공동서가 제한·문의처 상세 보강 및 앵커 `article-20-withdrawal`
 ...
 * - 2026-03-28: 현재 구현·설계 문서 기준 본문 정리(인증, 서가, 공동서가, 포인트·출석, VIP·구독·한도, 캐논 편집·투표, ISBN 조회·관리자 운영 등 반영; 향후 PG·결제 연계는 별도 고지 예정으로 명시)
      ...
      <div className="mt-8 space-y-8 text-sm leading-relaxed text-foreground/90">
        ...
        <section className="space-y-3">
          ...
          <ul className="list-disc space-y-1 pl-5">
            ...
            <li>
              공동서가·공개 기능을 이용한 스팸·무단 영리 홍보(운영자가 허용하는
              경우 제외)
            </li>
        ...
        <section className="space-y-3">
          ...
          <ul className="list-disc space-y-1 pl-5">
            ...
            <li>
              공동서가: 서가 생성·설명, 멤버 초대·역할, 일부 소장 정보의 공유
              표시
            </li>
            ...
            <li>
              플랜·VIP: 공동서가 개수·멤버·초대 한도, 메타 조회·스캔 등 이용
        ...
        <section className="space-y-3">
          ...
          <ul className="list-disc space-y-1 pl-5">
            <li>
              회원이 공동서가에 소장 정보를 연결하거나 공개 한줄평 등을 게시하는
          ...
          <div className="space-y-4 border-l-2 border-muted pl-4">
            ...
            <div className="space-y-2">
              ...
              <ul className="list-disc space-y-1 pl-5">
                ...
                <li>
                  내가 만든 공동서가 — 다른 멤버가 없으면 탈퇴와 함께 삭제되고,
