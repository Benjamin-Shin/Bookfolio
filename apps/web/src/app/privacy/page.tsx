 ...
 * - 2026-03-28: 현재 웹·모바일·DB 스키마 기준 개인정보처리방침 본문 정리(인증, 서가, 모임서가, 포인트·출석, VIP·구독, 캐논 편집·투표, ISBN 조회·Cloudinary 등 반영)
      ...
      <div className="mt-8 space-y-8 text-sm leading-relaxed text-foreground/90">
        <section className="space-y-3">
          ...
          <ul className="list-disc space-y-1 pl-5">
            ...
            <li>모임서가 생성·초대·멤버 관리 및 공유 소장 정보 표시</li>
            <li>
        ...
        <section className="space-y-3">
          ...
          <ul className="list-disc space-y-1 pl-5">
            ...
            <li>
              <strong>모임서가:</strong> 서가 이름·설명·유형, 멤버십·역할,
        ...
        <section className="space-y-3">
          ...
          <p>
            ...
            없이 파기합니다. 모임서가·공통 도서 정보(캐논) 참여 기록 등 타
