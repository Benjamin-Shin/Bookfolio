-- 모임서가: 개인 소장(user_books)을 서가에 연결하는 매핑. library_books / library_book_member_states 제거.
...
comment on table public.library_user_books is '모임서가에 노출할 user_books 행(멤버별 선택 공유).';
